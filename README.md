...
- **Globo 3D interactivo** — rotación automática, control orbital manual (drag + scroll)
...
- **100% client-side** — sin backend, sin API keys, datos bakeados en build time
...
│   ├── GlobeSphere.jsx   # Esfera base del globo (wireframe + atmósfera)
